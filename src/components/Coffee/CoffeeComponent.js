    ...
    const HomeBrewBeansList= [
      ...
      {
        beansName :"Jairo Arcila Santa Monica",
        roaster:"Parchmen Coffee, Singapore",
        altitude:"",
        varietal: "Typica Catimor",
        process:"Banana maceration",
        tastingnotes:"Banana and White Chocolate",
        personalremarks: "Taste as expected",
        beanspicture:require('../../images/Coffee/ParchmenCoffeeColombiaBanana.webp')
