...
const VentureCapitalDetails = [
    {
        ...
        description: " Portfolio submission during EntryLevel Venture Capital Analyst Course, where I independently chose one industry that I am interested in and three early stage companies that I would analyse.",
        contribution: " Throughout the program I chose Fintech Industry and FOMOpay, JiPay, and iPiD and eventually chose FOMOpay as my number one choice. I have conducted due diligence, investment memo, market analysis, customer analysis, dealflow action plan, and PitchDeck reviews. If you are a VC and interested to see, kindly contact me via Linkedin/Email"
    },
    {
        title: "My Personal Startup Notes",
        description: "Collated information of 189 startups(as of October 2022) since my last year of High School that I personally interested from daily reading/podcast about startup, technology, and leadership from Techcrunch, e27, TechInAsia, DailySocial, VulcanPost, MorningBrew, BFM, MyFirstMillion. In this case, I am interested with their ideas and not focusing on their business model/scalability/profitability. They are located in Indonesia, Singapore, US, other Southeast Asia Countries, and Sweden. If you are a VC and interested to see, kindly contact me via Linkedin/Email",
        contribution: "Fun fact: I stop listening to podcast due to other priorities, so I am not up to date nowadays"
    },
]
...
const TitleLists = [
    {
        ...
        logo:require("../images/thoughts.png"),
    },
    {
