...
const BooksList = [
  ...
  //     },
  {
        ...
        quotes:[
          ...
          '"If too much analysis is dangerous but none can leaed to failure, how do entreperreneurs know when to stop analyzing and start building. The answer is called the mvp"',
          ...
          '"Be tolerant of all mistakes the first time, vever allow twice"',
        ...
        howDiscovered:"Crashed into my friend's dorm, Radian, borrowed the book and never returned",
