export default function BlockCodingHeader() {
    ...
    return (
        ...
        <div className="container mx-auto flex px-10 pt-20 md:flex-row flex-col items-center">
            <div className=" md:w-1/2 w-1/3 lg:pr-24 md:pr-16 md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        ...
        <div className="container mx-auto flex px-10 pt-20 md:flex-row flex-col items-center">
            <div className=" md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                <h1 className="text-left mb-10 ml-20 text-4xl">
                    <b>Competitions</b>
                </h1>
            </div>
            <div className="flex-col">
        ...
        <div className="container mx-auto flex px-10 pt-20 md:flex-row flex-col items-center">
            <div className="lg:flex md:w-1/2 w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                <h1 className="text-left pb-10 pl-20 text-4xl">
                    <b>Group Projects</b>
                </h1>
            </div>
